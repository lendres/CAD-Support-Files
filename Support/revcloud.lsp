...
(Defun C:REVCLOUD (/ DIM_SCALE ; dimscale place holder
                   ...
                   SAVED_EN READTYP READVAL ARC_STYLE LOOP OPTIONS
                  ) 

  (acet-error-init 
    (List 
      (List "cmdecho" 0 "blipmode" 0 "osmode" 0 "limcheck" 0 
            ;;;               "plinewid" 0
      )
